...
\cvline{Tools}{Keras, Tensorflow, matplotlib, plotly, ggplot, git, HTCondor, Eigen}
...
{
\begin{itemize}
    \item Leading contributor to collaboration-wide software framework used by three thousand physicists, using python and optimzed C++ for fast data analysis
    ...
    \item Developed and deployed graph neural network for fast and accurate clustering of thousands of electrical signals into clusters of a common origin. 
...
Hundreds of peer-reviewed publications in major journals as part of the CMS Collaboration at CERN, as well as several limited-author publications on use of graph neural networks for clustering tasks in particle physics, including:
\begin{itemize}
