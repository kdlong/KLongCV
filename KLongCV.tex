...
Developing new machine-learning based reconstruction techniques to enable future measurements in the 
...
\section{\textsc{Leadership Roles in the CMS experiment}}
    ...
    with multiple vector bosons. Oversaw the development and publication of ten new measurements, 
    including the first observation of triple vector boson production and the most accurate measurements 
    to date of WZ, WW, and W$\gamma$ vector boson scattering. Currently reviewing and guiding
...
\item{\textbf{Convener of Matrix Element and Future Generators Group} \hfill{Jun. 2017 -- May 2019}}\\
    ...
    responsible for maintenance and development of event simulation software used to simulate
    billions of collisions for the use in CMS analyses.
