...
\cvline{Tools}{Machine learning (Keras, Tensorflow), visualisation (matplotlib, plotly, ggplot), data wrangling (pandas, numpy), version control (git), continuous integration (GitHub CI), batch computing (HTCondor), data bases (SQL)}
