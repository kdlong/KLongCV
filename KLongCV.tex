...
Working on analysis of big data collected by the Compact Muon Solenoid Experiment (CMS) at the CERN Large Hadron Collider (LHC).
Analyzing petabytes of data to find small hints of previously unmeasured processes
...
with scripting and steering via Bash and Python.

Leading role in production and validation of LHC collision simulations used by hundreds of collaborators.
Contributions to daily operations, data quality monitoring, and to future performance studies of the CMS muon gas detector subsystem.
