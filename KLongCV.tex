...
\address{{\bf Current Address} \\  906 Oakland Ave. \\  Madison, WI 53711 }
...
Analyzing petabytes of data collected by the Compact Muon Solenoid Experiment (CMS) 
at the CERN Large Hadron Collider (LHC)
to find small hints of previously unmeasured processes
and to increase precision of previous measurements with improved analysis techniques.
Contributions to software maintained by hundreds of collaborators in additional to independent development
of programs for specialized studies. Primarily developing and contributing to software in object-oriented C++ 
with scripting and steering via Python and Bash.

Contributions to publications focusing on precise measurements of known processes as well as searches for unexpected phenomena.
Leading role in production and validation of LHC collision simulations used by hundreds of collaborators.
Involved in daily operations, data quality monitoring, and future performance studies of the CMS muon gas detector subsystem.
\\
\\
...
\begin{itemize}
  \item{Convener of Matrix Element and Future Generators Group (Level 3) \hfill{Sep. 2017 - present}} \\
    Oversee subgroup of CMS Simulations Group
    responsible for maintenance and integration of external software developed by 
    theoretical physics community. Responsible for development and support for generation of
    physics sample generation of over 10 billion simulated collisions in 2017.
  \item{Standard Model Physics Group Monte Carlo Contact \hfill{Feb. 2016 - Aug. 2017}} \\
    Coordinating and assist 
    in the production of simulated samples for the CMS Standard Model Physics Group. 
...
\underline{Primary Research Activities}
\vspace{2mm}
\begin{itemize}
  ...
  \item{Future studies of electroweak WZ production at the HL-LHC} \\
    Projections of CMS electroweak WZ production measurements at upgraded LHC in 2035, including studies of
  ...
  \item{First 13 TeV measurements of WZ and ZZ cross sections} \\
    ...
    Differential measurements and anomalous
...
\begin{itemize}
  \item CSC Detector On-Call Shifts \hfill{Apr. 2016 - Jul. 2018} \\
    First contact person for CSC detector system during CMS commissioning and data-taking for three weeks per year
  ...
  \item Multi-boson contact person for CMS Cross Section Task Force \hfill{Oct. 2015 - Mar. 2017} \\
    ...
    their application to CMS simulated event samples. 
...
\item {\bf Computer Languages:} Extensive experience with C, C++, and Python. Experienced with Java and Bash. Familiar with HTML, Fortran, and Perl.
\item {\bf Technical Skills:} Scientific knowledge, software design and maintenance, distributed computing, big data, database use, extensive experience with ROOT software libraries, experienced with statistical analysis. 
\item {\bf Personal Skills:} Extensive experience in summarizing and presenting complex problems and solutions. Collaboration and strong interpersonal communication skills.
\end{itemize} 
